...
1. Select "Web application" and add "<http://127.0.0.1:5556/auth/google/callback>" as an authorized redirect URI.
1. Click create and add the printed client ID and secret to your environment using the following variables:
